...
namespace TeoGames.Mesh_Combiner.Scripts.Extension {
	...
	public static class MeshExtension {
		...
		public static bool IsCacheDisabled(this Mesh mesh) => mesh.name.Contains("[NO-CACHE]");
		...
		public static Mesh ToAnimated(this Mesh mesh) {
			if (mesh.IsCacheDisabled()) return mesh.bindposes.Length > 0 ? mesh : mesh.CorrectBones();
		...
		public static Mesh ToStatic(this Mesh mesh) {
			if (mesh.IsCacheDisabled()) return mesh.bindposes.Length == 1 ? mesh : mesh.CorrectBones();
		...
		private static Mesh CopyMesh(this Mesh mesh) => Object.Instantiate(mesh).CorrectBones();

		private static Mesh CorrectBones(this Mesh mesh) {
